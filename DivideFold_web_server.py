...
EXAMPLE_SEQUENCES = [
    "",
    ""
]
example_options = ["Select an example sequence", "16S ribosomal RNA", "Satellite tobacco mosaic virus"]

# Session state initialization
for key, default in [("rna_sequence", ""), ("example", example_options[0])]:
...
def main_page():
    ...
    def load_example():
        idx = example_options.index(st.session_state.example)
        if idx > 0:
            st.session_state.rna_sequence = EXAMPLE_SEQUENCES[idx - 1]

    # Selectbox to set example sequence
    st.selectbox(
        "",
